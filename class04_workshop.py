...
def check_age(user_age, age_restriction):
    ...
    y = input("your age: ")
    if y >= (user_age["age_restriction"]):
        return
    elif (user_age["age_restriction"]) == "G":
        return
    elif y < (user_age["age_restriction"]):
...
def buy_ticket(movie_list):
    ...
    #check_age(user_age,movie_list["age_restriction"])**********
